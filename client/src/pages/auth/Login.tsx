      ...
      <div className="hidden md:flex md:w-1/2 bg-primary/5 p-8 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <img 
            ...
            className="h-12 mb-8"
          />
          <h1 className="text-4xl font-bold mb-4">Welcome to<br />Ignite Labs</h1>
          <p className="text-lg text-gray-600 mb-6">Start your journey to becoming a job-ready full-stack developer with our comprehensive hands-on training program.</p>
          ...
          <div className="flex items-center space-x-4 p-4 bg-white/80 backdrop-blur-sm rounded-lg shadow-sm border border-primary/10">
            ...
            <div>
              <h3 className="font-semibold">Real-World Learning</h3>
              <p className="text-sm text-gray-600">Build actual projects that employers value</p>
            </div>
          </div>
        </div>
